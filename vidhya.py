...
def checkQueues (ssh, usernames):
	...
	for job in jobList:
		...
		jobInfo = cutString (jobInfo, "Output_Path = aqua:", "scaling.log")
...
def takeBackup (ssh, jobs, userDirName):
	backupLocations = {
	"mod10": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod10", 
	"mod20": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod20", 
	"mod33": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod33", 
	"mod50": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod50", 
	"mod66": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod66", 
	"mod80": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod80",
	"mod90": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod90",
	"mod100": "/home/raghuram/Documents/HPCE_backups/solvent_nonSolvent/T286/mod100"
	}
	...
	try:
		...
		os.system (" sshpass -p \"vidhya@123\" rsync --remove-source-files --progress -avz {}@10.24.6.200:{}/dump_nvt.lammpstrj {}/dump_new.lammpstrj".format (userDirName, jobs, targetLocation))
	...
	for jobs in finishedJobs:
		...
		for login in loginList:
			if (login in jobs):
				while (success == 0):
					try:
						currentOccupiedSpace = checkOccupiedSpace (ssh, "ic34784")
						...
						if (currentOccupiedSpace > 40.0):
							...
							# takeBackup (ssh, jobs, "ic34784")
						ssh_stdin, ssh_stdout, ssh_stderr = ssh.exec_command("cd {}; qsub v_jobs.cmd".format (jobs))
						success = 1
					except:
						success = 0
						ssh.close ()
						...
						try:
							ssh.connect(ip_hpce, username = credentials ["vidhya"][0], password = credentials ["vidhya"][1], look_for_keys = False)
						except Exception as e:
							pass
